...
class IntroView @JvmOverloads constructor(
    ...
    private fun setupDotsShape() {
        when (dotsShape) {
            DotsShape.PILL.id -> {
                _binding.indicatorBottom.setWithFactor(DefaultValues.WIDTH_PILL)
                _binding.indicatorTop.setWithFactor(DefaultValues.WIDTH_PILL)
                _binding.indicatorCenter.setWithFactor(DefaultValues.WIDTH_PILL)
            }

            DotsShape.CIRCLE.id -> {
                _binding.indicatorBottom.setWithFactor(DefaultValues.WIDTH_CIRCLE)
                _binding.indicatorTop.setWithFactor(DefaultValues.WIDTH_CIRCLE)
                _binding.indicatorCenter.setWithFactor(DefaultValues.WIDTH_CIRCLE)
            }
        }
    }
