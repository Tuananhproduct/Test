...
import com.appify.core.followLanguageSelected
 ...
 * 3. Use [followLanguageSelected] to request language change context.
 * Warning: If you don't do this, [SelectLanguageView] will work wrong way.
 * 4. Register a listener for the language change event using [onChangeLanguageListener].
 * 5. Set a custom list of languages using [setListLanguageCustom] if needed.
 * 6. Set a click listener for the bottom action button using [setBottomActionClickListener] if needed.
 *
...
//        setPositionSelected(currentLanguageCode ?: SharedPref.getLanguageCode())
        setupConfigDefault()
